...
func init() {
	...
	if err := cgocopy.PrecompileWithC[SimplePerson](
	...
	// Register Student
	if err := cgocopy.PrecompileWithC[Student](
	...
	// Register Point3D
	if err := cgocopy.PrecompileWithC[Point3D](
	...
	// Register GameObject
	if err := cgocopy.PrecompileWithC[GameObject](
	...
	// Register AllTypes
	if err := cgocopy.PrecompileWithC[AllTypes](
